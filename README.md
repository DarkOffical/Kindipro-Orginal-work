...
[![Deploy to Koyeb](https://www.koyeb.com/static/images/deploy/button.svg)](https://app.koyeb.com/deploy?type=git&repository=https://github.com/Azanpopz/Kindipro&env[BOT_TOKEN]&env[API_ID]&env[API_HASH]&env[CHANNELS]&env[ADMINS]&env[PICS]&env[LOG_CHANNEL]&env[AUTH_CHANNEL]&env[CUSTOM_FILE_CAPTION]&env[DATABASE_URI]&env[DATABASE_NAME]=moviesfiles&env[COLLECTION_NAME]=Telegram_files&run_command=python%20bot.py&branch=master&name=RashmikaBot)

[![Deploy to Heroku](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/DarkOffical/Kindipro-Orginal-work)
...
<p>
<pre>
git clone https://github.com/Azanpopz/Kindipro-Orginal-work
# Install Packages
